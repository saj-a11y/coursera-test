																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['c_id'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 ...
																									 <td><a href="delete_category.php?cat_del='.$rows['c_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i>Delete</a> 
